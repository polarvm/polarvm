...
elseif(POLAR_COMPILER_IS_GCC_COMPATIBLE)
   ...
   polar_add_flag_if_supported("-Werror=unguarded-availability-new" WERROR_UNGUARDED_AVAILABILITY_NEW)
...
if(WIN32 OR CYGWIN)
   if(BUILD_SHARED_LIBS OR POLAR_BUILD_POLAR_DYLIB)
      set(POLAR_ENABLE_PLUGINS ON)
   else()
      set(POLAR_ENABLE_PLUGINS OFF)
   endif()
else()
   set(POLAR_ENABLE_PLUGINS ON)
endif()
...
function(get_compile_definitions)
   ...
   endforeach()
   set(POLAR_DEFINITIONS "${result}" PARENT_SCOPE)
endfunction()
