...
#ifndef POLAR_BASIC_ADT_ALLOCATOR_LIST_H
#define POLAR_BASIC_ADT_ALLOCATOR_LIST_H
...
template <class T, class AllocatorT> class AllocatorList : AllocatorT
{
   struct Node : IntrusiveListNode<Node>
   {
      ...
      template <class... Ts> Node(Ts &&... values) : m_value(std::forward<Ts>(values)...)
      {}
...
public:
   ...
   template <class... Ts> void emplace_back(Ts &&... values)
   {
      emplace(end(), std::forward<Ts>(values)...);
   }

   template <class... Ts> void emplaceBack(Ts &&... values)
   {
      emplace(end(), std::forward<Ts>(values)...);
   }

   template <class... Ts> void emplace_front(Ts &&... values)
   {
      emplace(begin(), std::forward<Ts>(values)...);
   }

   template <class... Ts> void emplaceFront(Ts &&... values)
   {
      emplace(begin(), std::forward<Ts>(values)...);
   }
...
#endif // POLAR_BASIC_ADT_ALLOCATOR_LIST_H
