...
#ifndef POLAR_BASIC_ADT_FOLDING_SET_H
#define POLAR_BASIC_ADT_FOLDING_SET_H
...
template <class T, class VectorType = SmallVector<T*, 8>>
...
#endif // POLAR_BASIC_ADT_FOLDING_SET_H
