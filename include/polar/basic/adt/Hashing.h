...
/// \brief Implement the combining of integral values into a HashCode.
///
...
/// \brief Compute a HashCode for a sequence of values.
///
...
/// \brief Combine values into a single HashCode.
///
