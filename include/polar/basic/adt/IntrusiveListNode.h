...
#ifndef POLAR_BASIC_ADT_INTRUSIVE_LIST_NODE_H
#define POLAR_BASIC_ADT_INTRUSIVE_LIST_NODE_H
...
template <class OptionsType> struct SpecificNodeAccess : NodeAccess
{
protected:
...
#endif // POLAR_BASIC_ADT_INTRUSIVE_LIST_NODE_H
