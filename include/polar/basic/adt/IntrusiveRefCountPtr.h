...
#ifndef POLAR_BASIC_ADT_INTRUSIVE_REF_COUNT_PTR_H
#define POLAR_BASIC_ADT_INTRUSIVE_REF_COUNT_PTR_H
...
public:
   ...
   IntrusiveRefCountPtr(T *obj) : m_obj(obj) { retain(); }
...
template <class T> struct SimplifyType<const IntrusiveRefCountPtr<T>>
{
...
#endif // POLAR_BASIC_ADT_INTRUSIVE_REF_COUNT_PTR_H
