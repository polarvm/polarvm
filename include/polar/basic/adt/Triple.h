...
#ifndef POLAR_BASIC_ADT_TRIPLE_H
#define POLAR_BASIC_ADT_TRIPLE_H
...
public:
   ...
   enum class VendorType
   {
      ...
      Mesa,
      SUSE,
      LastVendorType = VendorType::SUSE
   };
...
public:
   ...
   Triple()
      : m_data(), m_arch(), m_subArch(), m_vendor(), m_os(), m_environment(),
        m_objectFormat()
   {}
