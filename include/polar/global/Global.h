...
#if defined(POLAR_NO_DEPRECATED)
#  undef POLAR_DEPRECATED
#  undef POLAR_DEPRECATED_X
#  undef POLAR_DEPRECATED_VARIABLE
#  undef POLAR_DEPRECATED_CONSTRUCTOR
#elif defined(POLAR_DEPRECATED_WARNINGS)
#  undef POLAR_DEPRECATED
#  define POLAR_DEPRECATED POLAR_DECL_DEPRECATED
#  undef POLAR_DEPRECATED_X
#  define POLAR_DEPRECATED_X(text) POLAR_DECL_DEPRECATED_X(text)
#  undef POLAR_DEPRECATED_VARIABLE
#  define POLAR_DEPRECATED_VARIABLE POLAR_DECL_VARIABLE_DEPRECATED
#  undef POLAR_DEPRECATED_CONSTRUCTOR
#  define POLAR_DEPRECATED_CONSTRUCTOR explicit POLAR_DECL_CONSTRUCTOR_DEPRECATED
#else
#  undef POLAR_DEPRECATED
#  define POLAR_DEPRECATED
#  undef POLAR_DEPRECATED_X
#  define POLAR_DEPRECATED_X(text)
#  undef POLAR_DEPRECATED_VARIABLE
#  define POLAR_DEPRECATED_VARIABLE
#  undef POLAR_DEPRECATED_CONSTRUCTOR
#  define POLAR_DEPRECATED_CONSTRUCTOR
#endif
...
#ifdef POLAR_CC_MSVC
#  define POLAR_NEVER_INLINE __declspec(noinline)
#  define POLAR_ALWAYS_INLINE __forceinline
#elif defined(POLAR_CC_GNU)
#  define POLAR_NEVER_INLINE __attribute__((noinline))
#  define POLAR_ALWAYS_INLINE inline __attribute__((always_inline))
#else
#  define POLAR_NEVER_INLINE
#  define POLAR_NEVER_INLINE inline
#endif
