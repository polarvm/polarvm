...
#ifndef POLAR_UTILS_BINARY_ITEM_STREAM_H
#define POLAR_UTILS_BINARY_ITEM_STREAM_H

#include "polar/basic/adt//ArrayRef.h"
#include "polar/utils/BinaryStream.h"
...
#endif // POLAR_UTILS_BINARY_ITEM_STREAM_H
