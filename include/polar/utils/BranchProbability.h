...
#ifndef POLAR_UTILS_BRANCHPROBABILITY_H
#define POLAR_UTILS_BRANCHPROBABILITY_H
                                               ...
                                               ProbabilityIter end)
{
   ...
   uint64_t sum = std::accumulate(begin, end, uint64_t(0),
                                  [&](uint64_t str, const BranchProbability &bp) {
         if (!bp.isUnknown()) {
...
#endif // POLAR_UTILS_BRANCHPROBABILITY_H
