...
#ifndef POLAR_UTILS_GENERIC_DOMTREE_H
#define POLAR_UTILS_GENERIC_DOMTREE_H
...
public:
   DomTreeNodeBase(NodeT *bb, DomTreeNodeBase *idom)
      : m_theBB(bb), m_idom(idom), m_level(m_idom ? m_idom->m_level + 1 : 0
   {}
...
#endif // POLAR_UTILS_GENERIC_DOMTREE_H
