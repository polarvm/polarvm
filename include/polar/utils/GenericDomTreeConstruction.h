...
#ifndef POLAR_UTILS_GENERIC_DOMTREE_CONSTRUCTION_H
#define POLAR_UTILS_GENERIC_DOMTREE_CONSTRUCTION_H

#include <queue>
#include "polar/basic/adt/ArrayRef.h"
#include "polar/basic/adt/DenseSet.h"
#include "polar/basic/adt/DepthFirstIterator.h"
#include "polar/basic/adt/PointerIntPair.h"
#include "polar/basic/adt/SmallPtrSet.h"
#include "polar/utils/Debug.h"
#include "polar/utils/GenericDomTree.h"
...
struct SemiNCAInfo {
   ...
   SemiNCAInfo(BatchUpdatePtr batchUpdatePtr) : m_batchUpdates(batchUpdatePtr)
   {}
...
#endif // POLAR_UTILS_GENERIC_DOMTREE_CONSTRUCTION_H
