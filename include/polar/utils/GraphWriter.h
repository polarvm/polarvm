...
public:
   GraphWriter(RawOutStream &outstream, const GraphType &graph, bool sn)
      : m_outstream(outstream), m_graph(graph)
   {
...
#endif // POLAR_UTILS_GRAPH_WRITER_H
