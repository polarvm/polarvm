...
#ifndef POLAR_UTILS_MEMORY_H
#define POLAR_UTILS_MEMORY_H
...
{
public:
   MemoryBlock() : m_address(nullptr), m_size(0)
   {}
...
public:
   ...
   explicit OwningMemoryBlock(MemoryBlock block) : m_memoryBlock(block)
   {}
