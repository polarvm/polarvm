...
#ifndef POLAR_UTILS_MEMORY_BUFFER_H
#define POLAR_UTILS_MEMORY_BUFFER_H
...
protected:
   ...
   static constexpr MappedFileRegion::MapMode MapMode =
...
public:
   ...
   MemoryBufferRef(MemoryBuffer& buffer)
      : m_buffer(buffer.getBuffer()), m_identifier(buffer.getBufferIdentifier())
   {}

   MemoryBufferRef(StringRef buffer, StringRef identifier)
      : m_buffer(buffer), m_identifier(identifier)
   {}
...
#endif // POLAR_UTILS_MEMORY_BUFFER_H
