...
#ifndef POLAR_UTILS_RANDOM_NUMBER_GENERATOR_H
#define POLAR_UTILS_RANDOM_NUMBER_GENERATOR_H

#include "polar/global/DataTypes.h" // Needed for uint64_t on Windows.
#include <random>
...
#endif // POLAR_UTILS_RANDOM_NUMBER_GENERATOR_H
