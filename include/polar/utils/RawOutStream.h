...
#ifndef POLAR_UTILS_RAW_OUT_STREAM_H
#define POLAR_UTILS_RAW_OUT_STREAM_H
...
public:
   ...
   /// descriptor.
   RawFdOstream(StringRef filename, std::error_code &errorCode,
                system::fs::OpenFlags Flags);
   
   /// FD is the file descriptor that this writes to.  If ShouldClose is true,
   /// this closes the file when the stream is destroyed. If FD is for stdout or
   /// stderr, it will not be closed.
   RawFdOstream(int fd, bool shouldClose, bool unbuffered = false);
   ...
   /// Return the value of the flag in this RawFdOstream indicating whether an
...
public:
   explicit RawNullOstream() = default;
...
#endif // POLAR_UTILS_RAW_OUT_STREAM_H
