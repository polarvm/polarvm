...
#ifndef POLAR_UTILS_SIGNALS_H
#define POLAR_UTILS_SIGNALS_H
...
bool remove_file_on_signal(StringRef filename, std::string *errMsg = nullptr);
...
void add_signal_handler(SignalHandlerCallback fnPtr, void *cookie);
...
void set_interrupt_function(void (*interruptFuncPtr)());

} // sys
} // polar

#endif // POLAR_UTILS_SIGNALS_H
