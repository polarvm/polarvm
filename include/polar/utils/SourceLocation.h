...
#ifndef POLAR_UTILS_SOURCE_LOCATION_H
#define POLAR_UTILS_SOURCE_LOCATION_H
...
{
public:
   SMLocation m_start, m_end;

   SMRange() = default;
   SMRange(std::nullptr_t) {}
   SMRange(SMLocation start, SMLocation end) : m_start(start), m_end(end)
   {
...
#endif // POLAR_UTILS_SOURCE_LOCATION_H
