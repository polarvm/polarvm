...
#ifndef POLAR_UTILS_STRING_EXTRAS_H
#define POLAR_UTILS_STRING_EXTRAS_H
...
{
   return detail::to_float(twine, num, strtold);
}
...
#endif // POLAR_UTILS_STRING_EXTRAS_H
