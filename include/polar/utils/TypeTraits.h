...
/// is_pod_like - This is a type trait that is used to determine whether a given
...
struct is_pod_like
{
   ...
   // matches the definition of is_pod_like closely.
...
struct is_pod_like<std::pair<T, U>>
{
   static const bool value = is_pod_like<T>::value && is_pod_like<U>::value;
};
