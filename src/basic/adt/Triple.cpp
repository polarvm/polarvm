...
//#include "polar/utils/TargetParser.h"
...
//   case Triple::EnvironmentType::AMDOpenCL: return "amdopencl";
//   case Triple::EnvironmentType::CoreCLR: return "coreclr";
//   case Triple::EnvironmentType::OpenCL: return "opencl";
...
//         .startsWith("amdopencl", Triple::EnvironmentType::AMDOpenCL)
//         .startsWith("coreclr", Triple::EnvironmentType::CoreCLR)
//         .startsWith("opencl", Triple::EnvironmentType::OpenCL)
