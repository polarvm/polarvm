...
#include "polar/basic/adt/ImmutableSet.h"
...
TEST_F(ImmutableSetTest, testEmptyIntSetTest)
{
...
TEST_F(ImmutableSetTest, testOneElemIntSetTest)
{
   ImmutableSet<int>::Factory f;
   ImmutableSet<int> S = f.getEmptySet();
...
TEST_F(ImmutableSetTest, testMultiElemIntSetTest)
{
   ImmutableSet<int>::Factory f;
   ImmutableSet<int> S = f.getEmptySet();
...
TEST_F(ImmutableSetTest, testRemoveIntSetTest)
{
   ImmutableSet<int>::Factory f;
   ImmutableSet<int> S = f.getEmptySet();
...
TEST_F(ImmutableSetTest, testCallbackCharSetTest)
{
...
TEST_F(ImmutableSetTest, testCallback2CharSetTest)
{
   ImmutableSet<char>::Factory f;
   ImmutableSet<char> S = f.getEmptySet();
...
TEST_F(ImmutableSetTest, testIterLongSetTest)
{
