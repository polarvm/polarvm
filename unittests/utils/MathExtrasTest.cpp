...
{
   EXPECT_FALSE(is_power_of_two_32(0));
   EXPECT_TRUE(is_power_of_two_32(1 << 6));
   EXPECT_TRUE(is_power_of_two_32(1 << 12));
   EXPECT_FALSE(is_power_of_two_32((1 << 19) + 3));
   EXPECT_FALSE(is_power_of_two_32(0xABCDEF0));
}

TEST(MathExtrasTest, testIsPowerOf2_64)
{
   EXPECT_FALSE(is_power_of_two_64(0));
   EXPECT_TRUE(is_power_of_two_64(1LL << 46));
   EXPECT_TRUE(is_power_of_two_64(1LL << 12));
   EXPECT_FALSE(is_power_of_two_64((1LL << 53) + 3));
   EXPECT_FALSE(is_power_of_two_64(0xABCDEF0ABCDEF0LL));
}
...
{
   EXPECT_EQ(0x44332211u, byte_swap_32(0x11223344));
   EXPECT_EQ(0xDDCCBBAAu, byte_swap_32(0xAABBCCDD));
}

TEST(MathExtrasTest, testByteSwap_64)
{
   EXPECT_EQ(0x8877665544332211ULL, byte_swap_64(0x1122334455667788LL));
   EXPECT_EQ(0x1100FFEEDDCCBBAAULL, byte_swap_64(0xAABBCCDDEEFF0011LL));
}
